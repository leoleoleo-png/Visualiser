...
//RED AND PINK
//vec4 swag4 = vec4(1.0, mic*(thresh/5.0), thresh*(colour1*2.0),mic);

vec4 swag4 = vec4(1.0, mic*(thresh/5.0)-colour1, thresh*(colour1*2.0),mic);
